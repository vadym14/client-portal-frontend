            ...
            <div class="m-auto flex flex-row  w-[53rem] card ">
                ...
                <div class="bg-[#7661E2] w-full flex flex-col">
                    <div class="m-auto">
                        ...
                        <button class=" flex mx-auto mt-5 bg-[#8A76F3] hover:bg-[#9e8df5] text-white font-normal py-2 px-4 rounded">Create Now!</button>
                        ...
                        <div class="sm:p-1 lg:p-4 w-full bg-white container ">
                            <div class="sm:block lg:hidden">
                                <div class="btn-group ">
                                    ...
                                    <button class="btn  w-1/2 whitespace-nowrap btn-primary btn-outline">Create Account</button>
                                </div>
