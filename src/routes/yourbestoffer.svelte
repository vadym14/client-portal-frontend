                ...
                <div>
                    ...
                    <div class="flex lg:flex-row flex-col-reverse lg:justify-end sm:justify-center gap-2 mt-10">
                            <div class="lg:block sm:hidden">
                                <button class="btn lg:btn-wide sm:w-full btn-outline btn-primary" on:click={()=>{goto('/')}}>
                                    FAQ
                                </button>
                            </div>
                        ...
                        <div>
                            <button class="btn lg:btn-wide sm:w-full btn-outline btn-primary" on:click={()=>{goto('/')}}>Contact Us</button>
                        </div>
                        <div>
